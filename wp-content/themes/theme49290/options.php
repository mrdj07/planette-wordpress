...
// ---------------------------------------------------------
			...
			$options['google_mixed_3'] = array(
								'id' => 'google_mixed_3',
								'std' => array( 'size' => '14px', 'lineheight' => '21px', 'face' => 'Ubuntu', 'style' => 'normal', 'character'  => 'latin', 'color' => '#9b9b9b'));
								
			$options['h1_heading'] = array(
								'id' => 'h1_heading',
								'std' => array( 'size' => '30px', 'lineheight' => '35px', 'face' => 'Ubuntu', 'style' => 'normal', 'character'  => 'latin', 'color' => '#4c4b4b'));
			
			$options['h2_heading'] = array(
								'id' => 'h2_heading',
								'std' => array( 'size' => '22px', 'lineheight' => '22px', 'face' => 'Ubuntu', 'style' => 'normal', 'character'  => 'latin', 'color' => '#4c4b4b'));
								
			$options['h3_heading'] = array(
								'id' => 'h3_heading',
								'std' => array( 'size' => '18px', 'lineheight' => '18px', 'face' => 'Ubuntu', 'style' => 'normal', 'character'  => 'latin', 'color' => '#4c4b4b'));
			
			$options['h4_heading'] = array(
								'id' => 'h4_heading',
								'std' => array( 'size' => '14px', 'lineheight' => '18px', 'face' => 'Ubuntu', 'style' => 'normal', 'character'  => 'latin', 'color' => '#4c4b4b'));
								
			$options['h5_heading'] = array(
								'id' => 'h5_heading',
								'std' => array( 'size' => '12px', 'lineheight' => '18px', 'face' => 'Ubuntu', 'style' => 'normal', 'character'  => 'latin', 'color' => '#4c4b4b'));
...
// ---------------------------------------------------------
			...
			$options['logo_typography'] = array(
								'id' => 'logo_typography',
								'std' => array( 'size' => '48px', 'lineheight' => '40px', 'face' => 'Arial, Helvetica, sans-serif', 'style' => 'normal', 'character'  => 'latin', 'color' => '#ffffff'));
...
// ---------------------------------------------------------
			...
			$options['menu_typography'] = array(
								'id' => 'menu_typography',
								'std' => array( 'size' => '12px', 'lineheight' => '18px', 'face' => 'Ubuntu', 'style' => 'normal', 'character'  => 'latin', 'color' => '#ffffff'));
...
//Social Links
		...
		$options['youtube_icon'] = array( 
							...
							"desc" => "Youtube Icon",
							"id" => "youtube_icon",
							"std" => get_stylesheet_directory_uri() . "/images/social/youtube.png",
							"type" => "upload");
...
// ---------------------------------------------------------
			...
			$options['footer_menu_typography'] = array(
								...
								'std' => array( 'size' => '12px', 'lineheight' => '18px', 'face' => 'Arial, Helvetica, sans-serif', 'style' => 'normal', 'character'  => 'latin', 'color' => '#35292e'));
